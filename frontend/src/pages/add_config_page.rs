use crate::{
    api,
    components::{YakManButton, YakManCard, YakManSelect},
};
use leptos::*;
use leptos_router::*;
    ...
    view! { cx,
        <div class="w-64">
            ...
            <div class="relative">
                <input
                    type="text"
                    class="block appearance-none w-full bg-white border border-gray-400 hover:border-indigo-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline"
